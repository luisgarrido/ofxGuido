#ifndef __ofxGuidoDevice__
#define __ofxGuidoDevice__
...
// --------------------------------------------------------------
class ofxGuidoDevice : public VGDevice {
	...
	public:
		ofxGuidoDevice(VGSystem* sys = 0);
		ofxGuidoDevice(int width, int height, VGSystem* sys = 0);
		virtual ~ofxGuidoDevice();
		...
		virtual void Arc(float left, float top, float right, float bottom, float startX,
